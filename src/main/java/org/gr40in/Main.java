...
public class Main {
    public static void main(String[] args) {
        Employer[] employers = {
                ...
                new Freelancer("MILLIE BOBBY BROWN", LocalDate.of(2004, 2, 19), new BigDecimal(500)),
                ...
                new Worker("ZENDAYA", LocalDate.of(1996, 9, 1), new BigDecimal(120_000)),
        ...
        printList(list);
        Collections.sort(list, new EmployerOldComparator());
        printList(list);
